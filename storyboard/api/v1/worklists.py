...
class WorklistsController(rest.RestController):
    ...
    def get_one(self, worklist_id):
        ...
        # TODO(SotK): Check ACL on private worklists
        if worklist:
    ...
    def get_all(self, title=None, creator_id=None, project_id=None,
        ...
        return [wmodels.Worklist.from_db_model(w) for w in worklists
    ...
    def put(self, worklist_id, worklist):
        ...
        updated_worklist = worklists_api.update(worklist_id, worklist_dict)
    ...
    def _route(self, args, request):
        ...
        return super(WorklistsController, self)._route(args, request)
